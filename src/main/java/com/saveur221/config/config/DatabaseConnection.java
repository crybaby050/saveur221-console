 ...
 *
 * <p>Les identifiants de connexion sont lus depuis un fichier {@code .env}
 * placé à la racine du projet (jamais committé dans Git — voir
 * {@code .gitignore}). Un fichier {@code .env.example} documente les
 * variables attendues pour toute personne clonant le dépôt.</p>
 *
 * <p>Implémentation volontairement minimale à ce stade du projet : une seule
...
public class DatabaseConnection {
    ...
    private static final Dotenv dotenv = Dotenv.configure()
            .ignoreIfMissing() // évite un crash si le fichier .env n'existe pas encore (ex. sur un environnement de CI)
            .load();
     ...
     *         manquantes, ou si la connexion à la base de données échoue
     */
