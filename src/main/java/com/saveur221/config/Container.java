...
/**
 * Conteneur central des dépendances de l'application.
 *
 * <p>Initialise les repositories et services en respectant leurs dépendances,
 * puis fournit leurs instances aux différentes couches de l'application.</p>
 */
public class Container {
    ...
    private final CategorieService categorieService =
            new CategorieService(categorieRepository, produitRepository);

    private final ProduitService produitService =
            new ProduitService(produitRepository);
    ...
    private final RecuService recuService =
            new RecuService(recuRepository);

    private final FactureService factureService =
            new FactureService(factureRepository);
    ...
    public RecuService getRecuService() {
        return recuService;
    }
